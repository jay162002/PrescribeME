<?php
    ...
    $sql = "SELECT * FROM `pharmacist_cred` where `t`='$token'";
...
<head>
    ...
    <title>PriscribeME | Add credentials</title>
    <!-- !FONT AWESOME -->
...
<body>
    ...
    <section class="dashboard_main_container" id="rec_cre_main_container">
        ...
        <div class="rec_cre_container">
                    ...
                    while($row = mysqli_fetch_assoc($result)){
                        ...
                        <td>
                            <form action="./partials/delete_cred.php" method="post">
                                <button class="del_cre" type="submit" name="delete_pharm_cred"><i class="fa-solid fa-trash"></i></button>
            ...
            <!-- !ADD CRED FORM -->
            <form action="./partials/insert_pharm_cred.php" method="post" id="add_front_desk_cred_form">
                <h3 class="add_front_desk_cre_form_header">Add Pharmacist</h3>
                <div class="input_main_container flex">
                    <div class="input_container">
                        <label for="add_phar_user_name">User Name</label>
                        <input type="text" name="add_phar_user_name" id="add_phar_user_name" required="true" value="<?php echo $token; ?>" readonly="true">
                    </div>
                    <div class="input_container">
                        <label for="add_phar_user_pass">Password</label>
                        <input type="text" name="add_phar_user_pass" id="add_phar_user_pass" required="true">
                    </div>
                </div>
                <button type="submit" class="btn" id="add_rec_btn" name="insert_pharma_cred"><i class="fa-solid fa-plus"></i>Add
                    Pharmacist</button>
            </form>
        </div>
    </section>
