<?php
    ...
    if($_SERVER["REQUEST_METHOD"] == "POST"){
        ...
        $sql = "SELECT * FROM pharmacist_cred where username='$email' and password='$password'";
        ...
        if($num == 1){
            ...
            if(isset($_POST['rememberme'])){
                setcookie('pusercookie',$email,time()+86400);
                setcookie('ppasscookie',$password,time()+86400);
            }

            session_start();
            $_SESSION['pharma_loggedin'] = true;
            $_SESSION['pharma_username'] = $email;
...
<head>
    ...
    <title>PrescribeME | Sign In-Pharmacist</title>
</head>
            ...
            <form action="./index.php" method="post">
                <div class="signin_email_container">
                    ...
                    <input type="text" name="rec_signin_name" id="rec_signin_name" class="input_box" required="true"
                        ...
                        value="<?php if(isset($_COOKIE['pusercookie'])){ echo $_COOKIE['pusercookie']; } ?>">
                </div>
                ...
                <div class="signin_password_container">
                    ...
                    <input type="password" name="signin_pass" id="rec_signin_password" class="input_box" required="true"
                        ...
                        value="<?php if(isset($_COOKIE['ppasscookie'])){ echo $_COOKIE['ppasscookie']; } ?>">
                </div>
                ...
                <div class="role_container">
                    ...
                    <a href="./" class="role_btn" id="main_btn">Pharmacist</a>
                </div>
            </form>
        </div>
    </div>
