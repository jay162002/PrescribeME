<?php
    ...
    $revenue_rows_sql = "SELECT * FROM `pharmacist_revenue` where `t`='$token';";
    $revenue_rows_result = mysqli_query($conn,$revenue_rows_sql);
...
<head>
    ...
    <title>PriscribeME | Revenue-Pharmacist</title>
    <!-- !FONT AWESOME -->
                ...
                <li class="signed_in_btn flex">
                    ...
                    <div class="profile_pop_up">
                        ...
                        <div class="pop_up_btn">
                            <a href="../forgot_pass.html" class="flex"><i class="fa-solid fa-user-lock"
    ...
    <div id="edit_header">
        ...
        <nav class="edit_link_container">
            <ul class="edit_nav_link_container">
                ...
                <li><a class="active" href="./revenue.php"><i class="fa-solid fa-indian-rupee-sign"></i>Revenue</a></li>
            ...
            <form action="./revenue.php" id="patient_search_input_form" method="post">
                <div class="patient_search_input_container flex">
                    <input type="text" name="search_patient"
                        placeholder="Search your patients with name, id, email or status" id="search_patient">
            ...
            <table class="dashboard_table" id="revenue_tbl">
                ...
                <tbody class="tbody">
                    ...
                    <?php
                        ...
                        if($search_var == false){
                            while($row = mysqli_fetch_assoc($revenue_rows_result)){
                                echo '<tr class="flex">
                                <td>' . $row['id'] . '</td>
                                ...
                                <td class="view_pre_btn">
                                    <form action="./view_revenue.php" method="post">                 
                                        ...
                                        <button type="submit" class="accept_btn" name="pharmacist_revenue_btn">View</button>
                                    </form>
                                </td>
                            </tr>';
                            }
                            ...
                            $search_query = "SELECT * FROM `pharmacist_revenue` WHERE (`fname` LIKE '%$search_token%' OR `lname` LIKE '%$search_token%' OR `phone_no`='$search_token' OR id='$search_token') and `t`='$token';";
