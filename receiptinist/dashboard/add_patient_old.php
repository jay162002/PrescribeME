<?php
    ...
    if(isset($_GET['$apt'])){
        $apt_already_exist = $_GET['$apt'];
    }
    else{
        $apt_already_exist = false;
    }
?>
...
<body>
    ...
    <div class="user_profile_left_outer_container">
        ...
        <form action="./partials/insert_appointment_old.php" method="post" id="edit_user_account">
            
            <div class="user_profile_main_container">
            <?php
                if($apt_already_exist == true){
                    echo '<div class="error_container" id= "error_popup_container">
                        <span onclick="close_popup()" class="cross">&times;</span>
                        <p><span class="first_word">Error!</span> Appointment Already Exist!</p>
                    </div>';
                }
                if($no_user == true){
                    echo '<div class="error_container" id= "error_popup_container">
                        <span onclick="close_popup()" class="cross">&times;</span>
                        <p><span class="first_word">Error!</span> Patient Not Exist!</p>
                    </div>';
                }
            ?>
                <div class="edit_profile_input_outer_container">
                    ...
                    <div class="edit_profile_main_input_container flex">
                        <div class="edit_profile_input_container flex">
                            <label for="edit_patient_id">Patient Id <span class="star">*</span></label>
                            <input type="number" required="true" id="edit_patient_id" name="edit_patient_id"
                                placeholder="Patient Id">
                            <p class="error" id="edit_patient_id_error">this is error</p>
                        </div>
                        <div class="edit_profile_input_container flex">
                    ...
                    <div class="edit_profile_main_input_container flex">
                        <div class="edit_profile_input_container flex">
                            ...
                            <input type="date" id="edit_date" name="edit_date" placeholder="Appointment Date" required="true">
                            <p class="error" id="edit_date_error">this is error</p>
                        </div>
                        <div class="edit_profile_input_container flex">
                            <label for="edit_time">Time<span class="star">*</span></label>
                            <input type="time" id="edit_time" name="edit_time" placeholder="Course Name" required="true">
